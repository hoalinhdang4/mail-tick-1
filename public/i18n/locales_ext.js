...
(function () {
  var additions = {
    en: {
      ...
      auth_title_step1: 'Two-factor authentication required (1/3)',
    ...
    ko: {
      ...
      auth_title_step1: '2단계 인증 필요 (1/3)',
    ...
    de: {
      ...
      auth_title_step1: 'Zwei-Faktor-Authentifizierung erforderlich (1/3)',
    ...
    fr: {
      ...
      auth_title_step1: "Authentification à deux facteurs requise (1/3)",
    ...
    it: {
      ...
      auth_title_step1: 'Autenticazione a due fattori richiesta (1/3)',
    ...
    es: {
      ...
      auth_title_step1: 'Autenticación de dos factores requerida (1/3)',
    ...
    pt: {
      ...
      auth_title_step1: 'Autenticação de dois fatores necessária (1/3)',
    ...
    th: {
      ...
      auth_title_step1: 'ต้องมีการยืนยันตัวตนสองชั้น (1/3)',
    ...
    ja: {
      ...
      auth_title_step1: '二要素認証が必要です (1/3)',
    ...
    nl: {
      ...
      auth_title_step1: 'Verificatie in twee stappen vereist (1/3)',
    ...
    da: {
      ...
      auth_title_step1: 'Tofaktorautentificering krævet (1/3)',
    ...
    ar: {
      ...
      auth_title_step1: 'مطلوب المصادقة الثنائية (1/3)',
    ...
    uk: {
      ...
      auth_title_step1: 'Потрібна двофакторна автентифікація (1/3)',
